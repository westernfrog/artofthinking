  ...
  return (
    <>
      ...
      <div className="row g-0 mb-5">
        <div className="col-md-8 border border-dark p-3 shadow">
          <div className="image1 py-5">
            <Spacer y={15} />
          </div>
        </div>
        <div className="col-md-4 border border-dark p-3 shadow">
        ...
        <div className="col-md-6 border border-dark p-3 shadow">
